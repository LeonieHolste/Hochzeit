...
const S = {
  ...
  hero:     { textAlign: 'center', padding: 'clamp(2rem,5vw,3rem) 1.5rem 1.5rem' },
...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSaveStatus('Verbindungsfehler. Bitte nochmals versuchen.');
    }
    setSubmitting(false);
  };
      ...
      {page === 'home' && (
        <div>
          <div style={S.hero}>
            ...
            <div style={S.divider} />
            <p style={{ ...S.eyebrow, marginBottom: '0.3rem' }}>03. September 2026</p>
            <p style={{ fontStyle: 'italic', color: '#9a8a7a', fontSize: '0.9rem', margin: 0 }}>Château de Veullerot · Liernais · Bourgogne, France</p>
          </div>
          <div style={{ maxWidth: '500px', margin: '0 auto', padding: '0 1.25rem 1rem' }}>
            <div style={{ background: 'rgba(200,180,154,0.12)', border: '0.5px solid #d4c4b0', borderRadius: '3px', padding: '2.5rem 1rem', textAlign: 'center', marginBottom: '1.75rem' }}>
              <div style={{ fontSize: '3.5rem', marginBottom: '0.5rem' }}>🏰</div>
              <p style={{ fontStyle: 'italic', color: '#7a6555', fontSize: '1rem', margin: '0 0 0.2rem' }}>Château de Veullerot</p>
              <p style={{ fontSize: '0.75rem', color: '#b0a090', margin: 0, letterSpacing: '0.08em' }}>LIERNAIS · BOURGOGNE · FRANCE</p>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.6rem', marginBottom: '1.5rem' }}>
              {[['📅','03.–07. September','2026'],['📍','Liernais','Bourgogne, France'],['🏰','Château de Veullerot','Venue'],['✉️','Anmeldung bis','01. Juli 2026']].map(([ico,l1,l2],i) => (
                <div key={i} style={{ ...S.card, textAlign: 'center', padding: '1rem', margin: 0 }}>
                  ...
                  <p style={{ fontSize: '0.75rem', color: '#9a8a7a', margin: 0 }}>{l2}</p>
                </div>
              ))}
            </div>
      ...
      {page === 'info' && (
        <div style={S.section}>
          ...
          {[
            ...
            { title: 'Kontakt', items: [
              ['📧','E-Mail','heiraten@leonie-und-moritz.de'],
      ...
      {page === 'rsvp' && (
        <div style={S.section}>
          <div style={{ textAlign: 'center', padding: '2rem 0 1.5rem' }}>
            ...
            <div style={S.divider} />
            <p style={{ fontStyle: 'italic', color: '#9a8a7a', fontSize: '0.88rem', margin: 0 }}>Bitte bis zum 01. Juli 2026 anmelden</p>
          </div>
          ...
          {submitted ? (
            <div style={{ ...S.card, textAlign: 'center', padding: '3rem 2rem' }}>
              ...
              <p style={{ color: '#6a5a4a', lineHeight: 1.8, margin: '0 0 1rem', fontSize: '0.95rem' }}>
                Eure Anmeldung ist bei uns eingegangen. Wir freuen uns riesig, dass ihr dabei seid, und melden uns bald mit weiteren Details.
              </p>
